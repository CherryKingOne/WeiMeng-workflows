"""Doubao Seedream 4.5 251128 request contract.
...
4. Seedream 4.5 defaults to jpeg output in the official docs and does not document
   output_format customization like Seedream 5.0 lite.
...
MODEL_FILE_SPEC = {
    ...
    "category": "image",
    "module_name": "doubao_seedream_4_5_251128",
    "default_model_id": "doubao-seedream-4-5-251128",
...
def build_images_generate_request(
    *,
    ...
    """Build the OpenAI-compatible images.generate payload for Ark Seedream 4.5."""
